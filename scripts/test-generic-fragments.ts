      ...
      filters: {
        ...
        params: {
          ...
          filters: [
            ...
            { field: "Title", label: "Title", kind: "search" },
            { field: "DueDate", label: "Due", kind: "dateRange" },
          ],
        },
      },
      "task-form": {
      ...
      table: {
        ...
        params: {
          ...
          filterBindings: [
            ...
            { field: "CustomerId" },
            { field: "DueDate", operator: "GTE", stateKey: "DueDateFrom" },
            { field: "DueDate", operator: "LTE", stateKey: "DueDateTo" },
          ],
